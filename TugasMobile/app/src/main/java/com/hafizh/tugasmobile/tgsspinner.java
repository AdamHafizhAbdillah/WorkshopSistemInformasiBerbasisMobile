...
public class tgsspinner extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tgsspinner);

        Spinner spinner;

        spinner = findViewById(R.id.spinner);

        //Array Adapter dengan memasukkan String dari file lissary.xml untuk menampilkan array country
        ...
        //Mengatur listener untuk mengetahui event/aksi saat item dipilih
